...
CREATE ROLE jtac_server1;
ALTER ROLE jtac_server1 WITH NOSUPERUSER INHERIT NOCREATEROLE NOCREATEDB LOGIN NOREPLICATION PASSWORD 'md582a2a7bf0daff2b522cf55a9d0cd0d58' VALID UNTIL 'infinity';
CREATE ROLE jtac_server2;
ALTER ROLE jtac_server2 WITH NOSUPERUSER INHERIT NOCREATEROLE NOCREATEDB LOGIN NOREPLICATION PASSWORD 'md5a7d206872bdcbe72d43a0f26e45eeec6' VALID UNTIL 'infinity';
CREATE ROLE loki;
...
GRANT armalive_server TO jtac_server1 GRANTED BY mahuja;
GRANT armalive_server TO jtac_server2 GRANTED BY mahuja;
