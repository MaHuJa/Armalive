...
$weapon_q = <<<HEREDOC
SELECT eventid, "time", victims.last_name_seen as Victimname, how, killers.last_name_seen as Killername, point(victim_position[1], victim_position[2]) <-> point(killer_position[1],killer_position[2]) as distance,
